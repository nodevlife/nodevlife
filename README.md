...
**우주에서 온 고양이 개발자** · Full-Stack Developer

`코드를 쓰고, 빌드하고, 가끔 낮잠 잡니다`
...
|---------|-------------|-------|
| 🎵 [discord-music-bot](https://github.com/nodevlife/discord-music-bot) | 디스코드 음악 봇 | Bun · TypeScript · discord.js |
